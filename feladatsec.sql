...
INSERT INTO `tartalom` (`id`, `sutiid`, `mentes`, `nev`, `suti_id`) VALUES
(1, 26, 'G', NULL, 0),
(2, 37, 'L', NULL, 0),
(3, 83, 'HC', NULL, 0),
(4, 91, 'G', NULL, 0),
...
(4, 'Norb', 'norb@gmail.com', '$2a$10$ieZMhYFTC4z4fANCU06hW.s8/0sWVnSqf.TG7l8HjXO6mXpglX16q', 'ROLE_Vendeg');
...
--
-- A tábla adatainak kiíratása `uzenet_osztaly`
--

INSERT INTO `uzenet_osztaly` (`id`, `content`) VALUES
(1, 'dfgdf'),
(2, 'sagffgd'),
(3, 'Szeretünk!');
